                    ...
                    >
                        ...
                        <div className={`p-3 rounded-lg relative flex-1 ${
                            ...
                            {msg.sources && msg.sources.length > 0 && !msg.isStreaming && (
                                <div className={`mt-2 pt-2 border-t ${msg.persona === AIPersona.Logos ? 'border-blue-200/50' : 'border-purple-200/50'}`}>
                                    <h4 className={`text-xs font-bold mb-1 flex items-center gap-1.5 ${msg.persona === AIPersona.Logos ? 'text-blue-800/70' : 'text-purple-800/70'}`}>
                                        ...
                                        {msg.sources.slice(0, 3).map((source, i) => (
                                            <li key={i} className="truncate">
                                                <a 
                                                    ...
                                                    className={`${msg.persona === AIPersona.Logos ? 'text-blue-600' : 'text-purple-600'} hover:underline`}
                                                    title={source.uri}
                                                >
                                                    {source.title}
                                                </a>
